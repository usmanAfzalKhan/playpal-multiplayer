// /pages/SinglePlayerHangman.jsx
import { useState, useEffect } from 'react';
import { useNavigate } from 'react-router-dom';
import './SinglePlayerHangman.css';


const words = ['javascript', 'firebase', 'netlify', 'react', 'playpal']; // Add more words later!

function SinglePlayerHangman() {
...
export default SinglePlayerHangman;
